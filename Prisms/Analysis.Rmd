...
```{r}
require(grid)
pdf("fig:TE.pdf", paper='USr', width=11)
...
pdf("fig:SWM.pdf", paper='USr', width=11)
p
dev.off()
```
...
pdf("fig:LB_Prisms.pdf", paper='USr', width=11)
p
dev.off()
```
...
require(gridExtra)
pdf("tbl:Prisms.pdf", paper='USr', width=11)
grid.arrange(tableGrob(tbl), tableGrob(tbl2), nrow=2, sub="tbl:Prisms(a and b)", clip=FALSE)
dev.off()
```
